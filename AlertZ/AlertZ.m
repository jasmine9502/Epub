...
@property(nonatomic,strong)IBOutlet UIView *alertBackView;
...
-(void)setUp
{
    ...
    //弹出框背景
    _alertBackView=[[UIView alloc]initWithFrame:CGRectMake(50, 44, WIDTH-40, 160)];
    _alertBackView.layer.cornerRadius=6;
    _alertBackView.center=CGPointMake(WIDTH/2, 568/2);
